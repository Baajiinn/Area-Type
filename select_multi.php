...
<body>
    ...
    <div>
        <a class="container" href="/multiplayer/ur_multiplayer.php">
            ...
            <br>
            <div class="descirption">Jouer avec vos amis ou contre d'autres personnes dans des parties non classées
            </div>
        </a>
    ...
    <div>
        <a class="container" href="/multiplayer/rk_multiplayer.php">
            ...
            <br>
            <div class="descirption">Jouer avec vos amis ou contre d'autres personnes dans des parties classées</div>
